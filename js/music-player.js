...
const MusicPlayer = (() => {
  ...
  const DEFAULT_TRACKS = [
    { id: 1, title: 'Ex-Otogibanashi', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Ex-Otogibanashi.flac', cover: null },
    { id: 2, title: 'Ex-Otogibanashi_ya', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Ex-Otogibanashi_ya.mp3', cover: null },
    { id: 3, title: 'Full Moon Serenade', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Full Moon Serenade.mp3', cover: null },
    { id: 4, title: 'FUSHI', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/FUSHI.mp3', cover: null },
    { id: 5, title: 'IROHA meets KAGUyA', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/IROHA meets KAGUyA.mp3', cover: null },
    { id: 6, title: "IROHA'S Dancing All Night", artist: 'Chou CPK', genre: 'ost', src: 'assets/music/IROHA\'S Dancing All Night.mp3', cover: null },
    { id: 7, title: 'melt', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/melt.flac', cover: null },
    { id: 8, title: 'OnyXXX', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/OnyXXX.mp3', cover: null },
    { id: 9, title: 'ray', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ray.flac', cover: null },
    { id: 10, title: 'Remember', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Remember.flac', cover: null },
    { id: 11, title: 'Reply', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Reply.flac', cover: null },
    { id: 12, title: 'Tell Your World', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/Tell Your World.mp3', cover: null },
    { id: 13, title: 'TSUKUYOMI', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/TSUKUYOMI.mp3', cover: null },
    { id: 14, title: 'うつし世 of 姫', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/うつし世の姫.mp3', cover: null },
    { id: 15, title: 'トリノコシティ', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/トリノコシティ.mp3', cover: null },
    { id: 16, title: 'ハッピーシンセサイザ', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ハッピーシンセサイザ.flac', cover: null },
    { id: 17, title: 'ヤチヨカップ優勝！', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ヤチヨカップ優勝！.mp3', cover: null },
    { id: 18, title: 'ヤチヨ絵巻', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ヤチヨ絵巻.mp3', cover: null },
    { id: 19, title: 'ロンリーユニバース', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ロンリーユニバース.mp3', cover: null },
    { id: 20, title: 'ワールドイズマイン', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/ワールドイズマイン.flac', cover: null },
    { id: 21, title: '夢をみる島', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/夢をみる島.mp3', cover: null },
    { id: 22, title: '星降る海', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/星降る海.flac', cover: null },
    { id: 23, title: '瞬間、シンフォニー', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/瞬間、シンフォニー.flac', cover: null },
    { id: 24, title: '私は、わたしの事が好き', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/私は、わたしの事が好き.flac', cover: null },
    { id: 25, title: '竹取オーバーナイトセンセーション', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/竹取オーバーナイトセンセーション.mp3', cover: null },
    { id: 26, title: '超かぐや姫！', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/超かぐや姫！.mp3', cover: null },
    { id: 27, title: '零ゆる光彩', artist: 'Chou CPK', genre: 'ost', src: 'assets/music/零ゆる光彩.mp3', cover: null },
  ];
